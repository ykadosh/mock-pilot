...
${LAYERS_HOVER_SCRIPT}
  ...
  window.addEventListener('message', function(e) {
    ...
    if (e.data.type === 'picker-highlight') { active = false; document.body.style.cursor = ''; handlePickerAction(e.data, function(el) { var rect = updateOverlay(el, false); window.parent.postMessage({ type: 'element-rect-update', rect: { top: rect.top, left: rect.left, width: rect.width, height: rect.height } }, '*'); }); return; }
