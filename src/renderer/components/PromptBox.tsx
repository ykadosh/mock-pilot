...
function ReadOnlyPromptBox({ onStartNewConversation }: { onStartNewConversation?: () => void }) {
  return (
    <div className="pointer-events-none fixed inset-x-0 bottom-6 z-70 flex justify-center px-4">
      <div className="pointer-events-auto w-full max-w-2xl rounded-2xl border border-slate-700/40 bg-[rgba(15,23,42,0.5)] p-3 shadow-2xl backdrop-blur-xl">
...
export function PromptBox(props: PromptBoxProps) {
  ...
  return (
    <div className="pointer-events-none fixed inset-x-0 bottom-6 z-70 flex justify-center px-4">
      <div className={`pointer-events-auto w-full max-w-2xl rounded-2xl shadow-2xl transition-colors ${props.loading ? "prompt-box-loading" : "border border-slate-600/20 bg-[rgba(15,23,42,0.5)] backdrop-blur-xl focus-within:border-slate-500/40"}`}>
